...
## QB
qb.formula <- formula(fantpt ~ overall + injury + stamina + throw_power + throw_accuracy + awareness + toughness + strength + age.x + years_pro + elusiveness)
...
## RB
rb.formula <- formula(fantpt ~ overall + injury + route_running + return + stamina + toughness + catching + acceleration + carrying + trucking + stamina + agility + elusiveness + speed + awareness + strength + age.x + years_pro)
...
## WR
wr.formula <- formula(fantpt ~ overall + injury + route_running + return + stamina + toughness + catching + acceleration + carrying + trucking + stamina + agility + elusiveness + speed + awareness + strength + age.x + years_pro)
...
te.formula <- formula(fantpt ~ overall + injury + route_running + return + stamina + toughness + catching + acceleration + carrying + trucking + stamina + agility + elusiveness + speed + awareness + strength + age.x + years_pro)
